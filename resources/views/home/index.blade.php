                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 order-2 order-lg-1">
                        <div class="banner-area__content">
                            ...
                            <a class="btn bg-primary" href="{{ route('cart-info') }}">Shop Now</a>
                        </div>
                    </div>
                    ...
                    <div class="features-active">
                        <div class="product-item">
                            <div class="product-item-image">
                                <a href="{{ route('product-details') }}"><img src="dist/images/product/05.jpg"
                                        alt="Product Name" class="img-fluid"></a>
                                <div class="cart-icon">
                                    <a href="{{ route('product-wishlist') }}"><i class="far fa-heart"></i></a>
                                    <a href="{{ route('cart-info') }}">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="productcategory text-center">
                            <div class="productcategory-img">
                                <a href="#"><img src="dist/images/categorys/wool-shoe.jpg" alt="images">
                                </a>
                            </div>
                            <div class="productcategory-text">
                                <a href="#">
